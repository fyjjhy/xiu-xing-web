          ...
          routes: [
            ...
            // },
            {
              ...
              routes: [
                ...
                { name: 'shu', path: '/shuList', component: './shu/Shu' },
                ...
                // { name: 'diMing', path: '/diMingList', component: './diMing/DiMing' },
                // { name: 'jiGou', path: '/jiGouList', component: './jiGouList/JiGou' },
                // { name: 'jiGou', path: '/jiGouList', component: './jiGou/JiGou' },
                // { name: 'zongMen', path: '/zongMenList', component: './zongMenList/ZongMen' },
                // { name: 'zongMen', path: '/zongMenList', component: './zongMen/ZongMen' },
                // { name: 'fuLu', path: '/fuLuList', component: './fuLuList/FuLu' },
                // { name: 'fuLu', path: '/fuLuList', component: './fuLu/FuLu' },
