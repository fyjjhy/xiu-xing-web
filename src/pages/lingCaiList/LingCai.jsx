...
let columns = [{
  title: '灵材代码',
  dataIndex: 'lingCaiCode',
  width: '90px',
}, {
  title: '灵材名称',
  dataIndex: 'lingCaiName',
  width: '175px',
}, {
  title: '小说',
...
export default class LingCai extends PureComponent {
  ...
  renderSimpleForm() {
    ...
    return (
      <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
        <Col md={8} sm={24}>
          <FormItem label="灵材名称" name="lingCaiName">
            <Input placeholder="请输入灵材名称" />
          </FormItem>
        </Col>
        <Col md={8} sm={24}>
          <FormItem label="灵材描述" name="lingCaiMiaoShu">
            <Input placeholder="请输入灵材描述" />
          </FormItem>
        </Col>
        <Col md={8} sm={24}>
    ...
    if (currentModel === 'edit') {
      ...
      return (
        <StandardForm
          ...
          initialValues={{
            lingCaiName: profile.lingCaiName,
            lingCaiCode: profile.lingCaiCode,
            xiaoShuoId: profile.xiaoShuoId,
            lingCaiMiaoShu: profile.lingCaiMiaoShu,
            id: profile.id
          }}
          // showDialog
          // visible
  ...
  renderAddDialog() {
    const { currentModel } = this.state;
    if (currentModel === 'add') {
      // const { xiaoShuo: { xiaoShuoList }, lingCai: { data  } } = this.props;
      // const profile = data || {};
      return (
        <StandardForm
          formColumnList={profileColumns}
