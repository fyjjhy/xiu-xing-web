...
import { Tooltip, Typography, Modal, Select, Collapse, List, Tag, Badge, Avatar, Descriptions, Switch } from 'antd';
...
export default class Cong extends PureComponent {
  ...
  render() {
    const { props } = this;
    const { currentModel, congInfo, optVisible, guiJiVisible, juSan } = this.state;
    return (
      <PageHeaderWrapper>
        <StandardPager
          columnWidth="150px"
