...
let columns = [{
  title: '灵丹代码',
  dataIndex: 'lingDanCode',
  width: '90px',
}, {
  title: '灵丹名称',
  dataIndex: 'lingDanName',
  width: '175px',
}, {
  title: '小说',
...
export default class LingDan extends PureComponent {
  ...
  renderSimpleForm() {
    ...
    return (
      <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
        <Col md={8} sm={24}>
          <FormItem label="灵丹名称" name="lingDanName">
            <Input placeholder="请输入灵丹名称" />
          </FormItem>
        </Col>
        <Col md={8} sm={24}>
          <FormItem label="灵丹描述" name="lingDanMiaoShu">
            <Input placeholder="请输入灵丹描述" />
          </FormItem>
        </Col>
        <Col md={8} sm={24}>
    ...
    if (currentModel === 'edit') {
      ...
      return (
        <StandardForm
          ...
          initialValues={{
            lingDanName: profile.lingDanName,
            lingDanCode: profile.lingDanCode,
            xiaoShuoId: profile.xiaoShuoId,
            lingDanMiaoShu: profile.lingDanMiaoShu,
            id: profile.id
          }}
          // showDialog
          // visible
  ...
  renderAddDialog() {
    const { currentModel } = this.state;
    if (currentModel === 'add') {
      // const { xiaoShuo: { xiaoShuoList }, lingDan: { data  } } = this.props;
      // const profile = data || {};
      return (
        <StandardForm
          formColumnList={profileColumns}
