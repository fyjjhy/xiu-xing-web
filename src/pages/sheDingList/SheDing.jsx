...
import {getSheDingColumns} from "../../utils/columns";

const { Group: ButtonGroup } = Button;
const { Paragraph } = Typography;

const sheDingColumns = getSheDingColumns();
    ...
    this.listColumns = this.listColumns.map(col => {
      ...
      if (col.dataIndex === 'sheDingName') {
        ...
        colum.render = (text => {
          ...
          return text && text.length > 15 ? <Tooltip overlayStyle={{ maxWidth: '400px', width: '400px' }} title={title}><Paragraph style={{ width: '400px', marginTop: '0px', marginBottom: '0px' }} ellipsis={{ row: 1 }}>{text}</Paragraph></Tooltip> : text
        });
      }
      return { ...col, ...colum };
    });
