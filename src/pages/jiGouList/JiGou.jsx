...
export default class JiGou extends PureComponent {
  ...
  renderSimpleForm() {
    ...
    return (
      <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
        <Col md={8} sm={24}>
          <FormItem label="机构名称" name="jiGouName">
            <Input placeholder="请输入机构名称" />
          </FormItem>
        </Col>
        <Col md={8} sm={24}>
          <FormItem label="机构描述" name="jiGouMiaoShu">
            <Input placeholder="请输入机构描述" />
          </FormItem>
        </Col>
        <Col md={8} sm={24}>
    ...
    if (currentModel === 'edit') {
      ...
      return (
        <StandardForm
          ...
          initialValues={{
            jiGouName: profile.jiGouName,
            jiGouCode: profile.jiGouCode,
            xiaoShuoId: profile.xiaoShuoId,
            jiGouMiaoShu: profile.jiGouMiaoShu,
            id: profile.id
          }}
          // showDialog
          // visible
  ...
  renderAddDialog() {
    const { currentModel } = this.state;
    if (currentModel === 'add') {
      // const { xiaoShuo: { xiaoShuoList }, jiGou: { data  } } = this.props;
      // const profile = data || {};
      return (
        <StandardForm
          formColumnList={profileColumns}
