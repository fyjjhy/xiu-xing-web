...
let columns = [{
  title: '灵器代码',
  dataIndex: 'lingQiCode',
  width: '90px',
}, {
  title: '灵器名称',
  dataIndex: 'lingQiName',
  width: '175px',
}, {
  title: '小说',
...
export default class LingQi extends PureComponent {
  ...
  renderSimpleForm() {
    ...
    return (
      <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
        <Col md={8} sm={24}>
          <FormItem label="灵器名称" name="lingQiName">
            <Input placeholder="请输入灵器名称" />
          </FormItem>
        </Col>
        <Col md={8} sm={24}>
          <FormItem label="灵器描述" name="lingQiMiaoShu">
            <Input placeholder="请输入灵器描述" />
          </FormItem>
        </Col>
        <Col md={8} sm={24}>
    ...
    if (currentModel === 'edit') {
      ...
      return (
        <StandardForm
          ...
          initialValues={{
            lingQiName: profile.lingQiName,
            lingQiCode: profile.lingQiCode,
            xiaoShuoId: profile.xiaoShuoId,
            lingQiMiaoShu: profile.lingQiMiaoShu,
            id: profile.id
          }}
          // showDialog
          // visible
  ...
  renderAddDialog() {
    const { currentModel } = this.state;
    if (currentModel === 'add') {
      // const { xiaoShuo: { xiaoShuoList }, lingQi: { data  } } = this.props;
      // const profile = data || {};
      return (
        <StandardForm
          formColumnList={profileColumns}
