...
import {getLingQiColumns} from "../../utils/columns";

const { Group: ButtonGroup } = Button;
const { Paragraph } = Typography;

const lingQiColumns = getLingQiColumns();
    ...
    this.listColumns = this.listColumns.map(col => {
      ...
      if (col.dataIndex === 'lingQiCode') {
        ...
        colum.render = (text => {
          ...
          return text && text.length > 15 ? <Tooltip overlayStyle={{ maxWidth: '300px', width: '300px' }} title={title}><Paragraph style={{ width: '300px', marginTop: '0px', marginBottom: '0px' }} ellipsis={{ row: 1 }}>{text}</Paragraph></Tooltip> : text
        });
      }
      return { ...col, ...colum };
    });
