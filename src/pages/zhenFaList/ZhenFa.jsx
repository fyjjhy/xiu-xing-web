...
let columns = [{
  title: '阵法代码',
  dataIndex: 'zhenFaCode',
  width: '90px',
}, {
  title: '阵法名称',
  dataIndex: 'zhenFaName',
  width: '175px',
}, {
  title: '小说',
...
export default class ZhenFa extends PureComponent {
  ...
  renderSimpleForm() {
    ...
    return (
      <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
        <Col md={8} sm={24}>
          <FormItem label="阵法名称" name="zhenFaName">
            <Input placeholder="请输入阵法名称" />
          </FormItem>
        </Col>
        <Col md={8} sm={24}>
          <FormItem label="阵法描述" name="zhenFaMiaoShu">
            <Input placeholder="请输入阵法描述" />
          </FormItem>
        </Col>
        <Col md={8} sm={24}>
    ...
    if (currentModel === 'edit') {
      ...
      return (
        <StandardForm
          ...
          initialValues={{
            zhenFaName: profile.zhenFaName,
            zhenFaCode: profile.zhenFaCode,
            xiaoShuoId: profile.xiaoShuoId,
            zhenFaMiaoShu: profile.zhenFaMiaoShu,
            id: profile.id
          }}
          // showDialog
          // visible
  ...
  renderAddDialog() {
    const { currentModel } = this.state;
    if (currentModel === 'add') {
      // const { xiaoShuo: { xiaoShuoList }, zhenFa: { data  } } = this.props;
      // const profile = data || {};
      return (
        <StandardForm
          formColumnList={profileColumns}
